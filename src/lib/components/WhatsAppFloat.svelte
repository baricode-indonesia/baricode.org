<script lang="ts">
	...
	let isWhatsAppPage = $derived(page.url.pathname === '/whatsapp');
</script>
	...
	<div class="fixed bottom-4 right-4 z-50 sm:bottom-6 sm:right-6">
		...
		>
			...
			>
				...
				<span
					class="absolute top-full right-6 -mt-1 border-4 border-transparent border-t-slate-900 dark:border-t-zinc-800"
				></span>
			</span>
		</a>
	</div>
